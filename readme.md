...
```
cd existing_repo
git remote add origin https://gitlab.com/epeeivan/my_php_framework.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/epeeivan/my_php_framework/-/settings/integrations)
